...
type FormState = {
  ...
  entityId: string; metadataUrl: string; ssoUrl: string; signingCertificateRef: string; nameIdAttribute: string; emailAttribute: string; groupAttribute: string; signatureAlgorithm: 'sha1' | 'sha256' | 'sha512'; ldapUrl: string;
