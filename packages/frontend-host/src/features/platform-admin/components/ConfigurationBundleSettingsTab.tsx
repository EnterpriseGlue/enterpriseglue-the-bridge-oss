...
type Preview = { valid: boolean; canonicalHash?: string; errors: Array<{ path: string; message: string }>; counts: Record<string, number>; roleTemplateBaselines?: Record<string, { copyFromRoleKey: string; fingerprint: string; permissions: string[] }> };
...
type SecretPreflight = { valid: boolean; canonicalHash?: string; availabilityHash?: string; available: boolean; errors: Array<{ path: string; message: string }>; references: Array<{ reference: string; locations: string[]; available: boolean; reason?: string }> };
