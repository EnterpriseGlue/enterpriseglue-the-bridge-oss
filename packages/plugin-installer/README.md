...
```json
{
  ...
  "mode": "keyless",
  "certificateIdentity": "https://github.com/EnterpriseGlue/ion-support-agent/.github/workflows/plugin-release.yml@refs/heads/main",
  "certificateOidcIssuer": "https://token.actions.githubusercontent.com",
  "githubWorkflowRepository": "EnterpriseGlue/ion-support-agent",
