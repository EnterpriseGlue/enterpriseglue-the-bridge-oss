...
import { assertKnownAuthzAction } from '@enterpriseglue/shared/authz/permission-actions.js';
...
export function requireApiClientAction(scope: string, actionId: string) {
