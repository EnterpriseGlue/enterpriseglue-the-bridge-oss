 ...
 * 
 * Note: Canonical definitions are in @enterpriseglue/shared/contracts/roles
...
/**
 * Project-level roles (matching @enterpriseglue/shared/contracts/roles)
 */
...
/**
 * Engine-level roles (matching @enterpriseglue/shared/contracts/roles)
 */
