        ...
        if (change.objectType === 'engine') {
          ...
          if (change.operation === 'create' && desired) {
            ...
            await engineRepo.insert({
              ...
              runtimeAccessScope: desired.runtimeAccessScope, deploymentIntegration: desired.deploymentIntegration, metadataDiscoveryEnabled: desired.metadataDiscoveryEnabled, connectionMode: desired.connectionMode,
            ...
            await engineRepo.update({ id: change.currentId }, {
              ...
              runtimeAccessScope: desired.runtimeAccessScope, deploymentIntegration: desired.deploymentIntegration, metadataDiscoveryEnabled: desired.metadataDiscoveryEnabled, connectionMode: desired.connectionMode, updatedAt: now,
            });
