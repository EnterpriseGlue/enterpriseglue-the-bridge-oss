...
const {
  ...
  LegacySsoAssignmentMappingMigrationResponseSchema,
...
registry.registerPath({ method: 'post', path: '/api/authz/sso-mappings', ...authzExtension('platform.sso.platform-role-mappings.manage', 'POST', '/api/authz/sso-mappings'), request: { body: { content: { 'application/json': { schema: LegacySsoPlatformMappingCreateRequestSchema } } } }, responses: { 201: { description: 'Mapping created', content: { 'application/json': { schema: SsoClaimsMappingSchemaOpenApi } } } } });
registry.registerPath({ method: 'post', path: '/api/authz/sso-mappings/{id}/migrate-provider-neutral', ...authzExtension('platform.sso.platform-role-mappings.manage', 'POST', '/api/authz/sso-mappings/{id}/migrate-provider-neutral'), request: { params: z.object({ id: z.string() }), body: { content: { 'application/json': { schema: LegacySsoMappingMigrationRequestSchema } } } }, responses: { 200: { description: 'Existing equivalent provider-neutral mapping and platform group role assignment', content: { 'application/json': { schema: LegacySsoPlatformMappingMigrationResponseSchema } } }, 201: { description: 'Global provider-neutral identity mapping and platform group role assignment created while retaining the legacy mapping', content: { 'application/json': { schema: LegacySsoPlatformMappingMigrationResponseSchema } } }, 400: { description: 'Legacy mapping cannot be migrated safely' }, 404: { description: 'Legacy mapping, global identity provider, or global authorization group not found' } } });
registry.registerPath({ method: 'put', path: '/api/authz/sso-mappings/{id}', ...authzExtension('platform.sso.platform-role-mappings.manage', 'PUT', '/api/authz/sso-mappings/{id}'), request: { params: z.object({ id: z.string() }), body: { content: { 'application/json': { schema: LegacySsoPlatformMappingUpdateRequestSchema } } } }, responses: { 200: { description: 'Mapping updated', content: { 'application/json': { schema: AuthzMutationSuccessResponseSchema } } } } });
...
registry.registerPath({ method: 'get', path: '/api/authz/legacy-mapping-coverage', ...authzExtension('platform.sso.group-mappings.read', 'GET', '/api/authz/legacy-mapping-coverage'), responses: { 200: { description: 'Legacy SSO mapping replacement candidate diagnostics', content: { 'application/json': { schema: z.array(LegacyMappingCoverageItemSchema) } } } } });
registry.registerPath({ method: 'get', path: '/api/authz/legacy-mapping-retirement-readiness', ...authzExtension('platform.sso.group-mappings.read', 'GET', '/api/authz/legacy-mapping-retirement-readiness'), responses: { 200: { description: 'Fail-closed readiness gate for legacy mapping evaluator retirement', content: { 'application/json': { schema: LegacyMappingRetirementReadinessSchema } } } } });
registry.registerPath({ method: 'post', path: '/api/authz/legacy-mapping-coverage/{id}/verify', ...authzExtension('platform.sso.group-mappings.manage', 'POST', '/api/authz/legacy-mapping-coverage/{id}/verify'), request: { params: z.object({ id: z.string() }), body: { content: { 'application/json': { schema: LegacyMappingCoverageVerifyRequestSchema } } } }, responses: { 204: { description: 'Representative replacement verification recorded in the authorization audit log' }, 400: { description: 'Selected replacement is not a current candidate or verification note is invalid' } } });
registry.registerPath({ method: 'post', path: '/api/authz/legacy-mapping-retirement/disable', ...authzExtension('platform.sso.group-mappings.manage', 'POST', '/api/authz/legacy-mapping-retirement/disable'), request: { body: { content: { 'application/json': { schema: LegacyMappingRetirementRequestSchema } } } }, responses: { 200: { description: 'All covered legacy mapping rows disabled after the readiness gate passed', content: { 'application/json': { schema: LegacyMappingRetirementResultSchema } } }, 403: { description: 'Legacy mapping retirement readiness gate did not pass' } } });
registry.registerPath({ method: 'post', path: '/api/authz/legacy-mapping-retirement/disable-global', ...authzExtension('platform.sso.platform-role-mappings.manage', 'POST', '/api/authz/legacy-mapping-retirement/disable-global'), request: { body: { content: { 'application/json': { schema: LegacyGlobalMappingRetirementRequestSchema } } } }, responses: { 200: { description: 'Globally scoped covered legacy mapping rows disabled after the readiness gate passed', content: { 'application/json': { schema: LegacyMappingRetirementResultSchema } } }, 403: { description: 'Missing global mapping management permission or retirement readiness gate did not pass' } } });
registry.registerPath({ method: 'post', path: '/api/authz/sso-assignment-mappings', ...authzExtension('platform.sso.engine-assignments.manage', 'POST', '/api/authz/sso-assignment-mappings'), request: { body: { content: { 'application/json': { schema: SsoAssignmentMappingInsertSchema } } } }, responses: { 201: { description: 'SSO engine assignment mapping created', content: { 'application/json': { schema: AuthzCreatedIdResponseSchema } } } } });
registry.registerPath({ method: 'post', path: '/api/authz/sso-assignment-mappings/{id}/migrate-provider-neutral', ...authzExtension('platform.sso.engine-assignments.manage', 'POST', '/api/authz/sso-assignment-mappings/{id}/migrate-provider-neutral'), request: { params: z.object({ id: z.string() }), body: { content: { 'application/json': { schema: LegacySsoMappingMigrationRequestSchema } } } }, responses: { 200: { description: 'Existing equivalent provider-neutral identity mapping and exact-engine group role assignment', content: { 'application/json': { schema: LegacySsoAssignmentMappingMigrationResponseSchema } } }, 201: { description: 'Provider-neutral exact-engine group role assignment created for a safe group/role, exact email-domain, or allowlisted exact custom claim while retaining the source mapping', content: { 'application/json': { schema: LegacySsoAssignmentMappingMigrationResponseSchema } } }, 400: { description: 'Legacy mapping cannot be migrated safely, uses an unallowlisted custom claim, or requires an explicit Engine Set design' }, 404: { description: 'Legacy mapping, identity provider, target engine, or authorization group not found' } } });
registry.registerPath({ method: 'put', path: '/api/authz/sso-assignment-mappings/{id}', ...authzExtension('platform.sso.engine-assignments.manage', 'PUT', '/api/authz/sso-assignment-mappings/:id'), request: { params: z.object({ id: z.string() }), body: { content: { 'application/json': { schema: SsoAssignmentMappingUpdateSchema } } } }, responses: { 200: { description: 'SSO engine assignment mapping updated', content: { 'application/json': { schema: AuthzMutationSuccessResponseSchema } } } } });
...
registry.registerPath({ method: 'post', path: '/api/authz/sso-group-mappings', ...authzExtension('platform.sso.group-mappings.manage', 'POST', '/api/authz/sso-group-mappings'), request: { body: { content: { 'application/json': { schema: SsoGroupMappingInsertSchema } } } }, responses: { 201: { description: 'SSO group mapping created', content: { 'application/json': { schema: AuthzCreatedIdResponseSchema } } } } });
registry.registerPath({ method: 'post', path: '/api/authz/sso-group-mappings/{id}/migrate-provider-neutral', ...authzExtension('platform.sso.group-mappings.manage', 'POST', '/api/authz/sso-group-mappings/{id}/migrate-provider-neutral'), request: { params: z.object({ id: z.string() }), body: { content: { 'application/json': { schema: LegacySsoGroupMappingMigrationRequestSchema } } } }, responses: { 200: { description: 'Existing equivalent provider-neutral mapping', content: { 'application/json': { schema: LegacySsoGroupMappingMigrationResponseSchema } } }, 201: { description: 'Provider-neutral mapping created for a safe group/role, exact email-domain, or allowlisted exact custom claim while retaining the legacy mapping', content: { 'application/json': { schema: LegacySsoGroupMappingMigrationResponseSchema } } }, 400: { description: 'Legacy mapping cannot be represented safely or uses an unallowlisted custom claim' }, 404: { description: 'Legacy mapping, provider, or target group not found' } } });
registry.registerPath({ method: 'put', path: '/api/authz/sso-group-mappings/{id}', ...authzExtension('platform.sso.group-mappings.manage', 'PUT', '/api/authz/sso-group-mappings/:id'), request: { params: z.object({ id: z.string() }), body: { content: { 'application/json': { schema: SsoGroupMappingUpdateSchema } } } }, responses: { 200: { description: 'SSO group mapping updated', content: { 'application/json': { schema: AuthzMutationSuccessResponseSchema } } } } });
...
registry.registerPath({ method: 'get', path: '/git-api/credentials/{providerId}', ...authzExemption('GET', '/git-api/credentials/:providerId'), request: { params: z.object({ providerId: z.string() }) }, responses: { 200: { description: 'Git credential metadata for provider', content: { 'application/json': { schema: GitCredentialSchema } } }, 404: { description: 'Not found' } } });
...
registry.registerPath({ method: 'patch', path: '/git-api/credentials/{credentialId}', ...authzExemption('PATCH', '/git-api/credentials/:credentialId'), request: { params: z.object({ credentialId: z.string() }), body: { content: { 'application/json': { schema: RenameGitCredentialRequestSchema } } } }, responses: { 200: { description: 'Credential updated', content: { 'application/json': { schema: z.object({ success: z.literal(true) }) } } } } });
...
registry.registerPath({ method: 'get', path: '/git-api/credentials/{credentialId}/namespaces', ...authzExemption('GET', '/git-api/credentials/:credentialId/namespaces'), request: { params: z.object({ credentialId: z.string() }) }, responses: { 200: { description: 'Available namespaces', content: { 'application/json': { schema: z.array(GitCredentialNamespaceSchema) } } } } });
