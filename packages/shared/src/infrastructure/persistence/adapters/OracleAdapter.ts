...
import {
  ...
  Tenant, TenantDiscoveryChallenge, TenantDiscoveryDomain, TenantDomain, TenantLifecycleOperation, TenantLoginPolicy, TenantRoutingAlias, CloudEmailSignup, CloudPasskey, CloudPasskeyChallenge,
