...
- [Operate the Plugin Manager](runbooks/plugin-manager-operations.md)
- [Source-free Plugin Manager Compose Kit](../infra/docker/plugin-manager/README.md)
- [Static Frontend and CDN Routing Contract](../infra/cdn/plugin-routing/routing-contract.json)
...
- [Platform Cloud Identity](reference/platform-cloud-identity.md)
...
- [Plugin Platform, FGA, and Authoring](architecture/12-plugin-platform-and-authoring.md)
