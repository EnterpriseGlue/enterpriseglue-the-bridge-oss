...
- [x] ✅ Replace `ProjectDetail` membership-role authorization fallbacks with scoped project permission and action decisions for files, members, settings, Git, deployment targets, and ownership controls.
