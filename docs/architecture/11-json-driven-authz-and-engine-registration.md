...
- [x] ✅ Extract the Runtime Resources tab body into `pages/access-control/RuntimeResourcesPanel.tsx`; the parent retains query, reconciliation mutation, and selected-engine state while the panel owns inventory status, controls, and presentation.
