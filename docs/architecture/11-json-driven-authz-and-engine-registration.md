...
- [x] ✅ Extract the role-assignment results table into `pages/access-control/RoleAssignmentsTable.tsx`; source/ownership badges and removable-assignment rules remain unchanged while the assignment form stays with the tab container.
