...
- [ ] ⬜ Complete role-editor risk filters and sticky save/cancel controls. Grouped permission accordions, permission search, selected-only filtering, responsive checkboxes, system-role duplication, config ownership states, and permission selection during new-role creation are complete.
