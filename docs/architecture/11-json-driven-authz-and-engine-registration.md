...
- [ ] ⬜ Split the remaining `packages/backend-host/src/modules/platform-admin/routes/authz.ts` families into focused roles/permissions, assignments/groups, identity, engine sets/runtime resources, targets, external registration, and audit routers.
