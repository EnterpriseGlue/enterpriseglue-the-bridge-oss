...
4. For plugin-platform changes, verify the public package/toolchain artifacts
   and supported plugin-consumer compatibility lanes. Do not wait for or create
   an EE synchronization follow-up.
