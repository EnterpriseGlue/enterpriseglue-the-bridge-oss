...
Generated at: 2026-09-24T14:41:47.083Z
...
| @azure/msal-node | 5.6.0 | MIT | https://github.com/AzureAD/microsoft-authentication-library-for-js.git | backend, frontend, packages/shared, root |
...
| @simplewebauthn/server | 13.3.0 | MIT | git+https://github.com/MasterKale/SimpleWebAuthn.git | backend, packages/backend-host |
...
| bcryptjs | 3.0.3 | BSD-3-Clause | https://github.com/dcodeIO/bcrypt.js.git | backend, frontend, packages/backend-host, packages/shared, root |
| bitbucket | 2.12.0 | MIT | github:MunifTanjim/node-bitbucket | backend, frontend, packages/shared, root |
...
| cookie-parser | 1.4.7 | MIT | expressjs/cookie-parser | backend, frontend, packages/shared, root |
| cors | 2.8.6 | MIT | expressjs/cors | backend, frontend, packages/backend-host, packages/shared, root |
...
| dotenv | 17.4.2 | BSD-2-Clause | git://github.com/motdotla/dotenv.git | backend, frontend, packages/shared, root |
| es-module-lexer | 2.1.0 | MIT | git+https://github.com/guybedford/es-module-lexer.git | packages/plugin-runtime |
| escape-html | 1.0.3 | MIT | component/escape-html | backend, frontend, packages/shared, root |
| express-rate-limit | 8.6.2 | MIT | git+https://github.com/express-rate-limit/express-rate-limit.git | backend, frontend, packages/shared, root |
| express | 5.2.1 | MIT | expressjs/express | backend, frontend, packages/backend-host, packages/shared, root |
