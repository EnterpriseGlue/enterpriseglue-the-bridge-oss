...
import passwordRouter from '../../../../../packages/backend-host/src/modules/auth/routes/password.js';
...
import * as passwordUtils from '@enterpriseglue/shared/utils/password.js';
