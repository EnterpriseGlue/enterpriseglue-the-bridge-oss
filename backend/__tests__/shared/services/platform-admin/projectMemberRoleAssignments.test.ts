...
describe('project member role assignments', () => {
  it('writes manual canonical assignments without deprecated aliases or legacy source', async () => {
    ...
    await writeProjectMemberRoleAssignments(store, {
      projectId: 'project-1',
      tenantId: 'tenant-1',
      userId: 'user-1',
      roles: ['developer'],
