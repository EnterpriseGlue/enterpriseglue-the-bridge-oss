...
const ENTITIES_DIR = path.resolve(__dirname, '../../../../packages/shared/src/infrastructure/persistence/entities');
const MIGRATIONS_DIR = path.resolve(__dirname, '../../../../packages/shared/src/db/migrations');
