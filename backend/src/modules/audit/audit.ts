 ...
 */
router.get('/api/audit/logs', requireAuth, requirePlatformAdmin, asyncHandler(async (req, res) => {
  try {
    ...
    throw Errors.internal('Failed to retrieve audit logs');
  }
}));
 ...
 */
router.get('/api/audit/logs/user/:userId', requireAuth, requirePlatformAdmin, asyncHandler(async (req, res) => {
  try {
    ...
    throw Errors.internal('Failed to retrieve user audit logs');
  }
}));
 ...
 */
router.get('/api/audit/logs/resource/:resourceType/:resourceId', requireAuth, requirePlatformAdmin, asyncHandler(async (req, res) => {
  try {
    ...
    throw Errors.internal('Failed to retrieve resource audit logs');
  }
}));
...
router.get('/api/audit/stats', requireAuth, requirePlatformAdmin, asyncHandler(async (req, res) => {
  try {
    ...
    throw Errors.internal('Failed to retrieve audit statistics');
  }
}));
 ...
 */
router.get('/api/audit/actions', requireAuth, requirePlatformAdmin, asyncHandler(async (req, res) => {
  try {
    const dataSource = await getDataSource();
    const auditRepo = dataSource.getRepository(AuditLog);
