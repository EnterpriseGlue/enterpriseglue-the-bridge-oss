...
assert_contains "$BACKEND_DTS" "authzRoutes" "backend authz route manifest"
assert_contains "$BACKEND_DTS" "EnterpriseBackendAuthzContext" "backend authz helper context"
assert_contains "$BACKEND_DTS" "requireAction" "backend authz requireAction helper"
