...
data:
  ...
  EG_ENGINE_ALLOWED_HOSTS: "${EG_ENGINE_ALLOWED_HOSTS:-}"
  EG_ENFORCE_ENGINE_ENDPOINT_POLICY: "true"
  EG_ENGINE_ALLOW_PRIVATE_HOSTS: "${EG_ENGINE_ALLOW_PRIVATE_HOSTS:-false}"
  EG_ALLOW_INSECURE_ENGINE_HTTP: "${EG_ALLOW_INSECURE_ENGINE_HTTP:-false}"
  EG_ADMIN_INTEGRATION_ALLOWED_HOSTS: "${EG_ADMIN_INTEGRATION_ALLOWED_HOSTS:-}"
  EG_ENFORCE_ADMIN_INTEGRATION_ENDPOINT_POLICY: "true"
  EG_ADMIN_INTEGRATION_ALLOW_PRIVATE_HOSTS: "${EG_ADMIN_INTEGRATION_ALLOW_PRIVATE_HOSTS:-false}"
  EG_IDENTITY_PROVIDER_ALLOWED_HOSTS: "${EG_IDENTITY_PROVIDER_ALLOWED_HOSTS:-}"
  EG_ENFORCE_IDENTITY_PROVIDER_ENDPOINT_POLICY: "true"
  EG_IDENTITY_PROVIDER_ALLOW_PRIVATE_HOSTS: "${EG_IDENTITY_PROVIDER_ALLOW_PRIVATE_HOSTS:-false}"
  EG_IDENTITY_FLOW_RATE_LIMIT_MAX: "${EG_IDENTITY_FLOW_RATE_LIMIT_MAX:-300}"
  SSO_DIAGNOSTICS_INTERVAL_MS: "${SSO_DIAGNOSTICS_INTERVAL_MS:-60000}"
  EG_LDAP_RECONCILIATION_IDENTITY_LIMIT: "${EG_LDAP_RECONCILIATION_IDENTITY_LIMIT:-10000}"
  EG_LDAP_RECONCILIATION_CONCURRENCY: "${EG_LDAP_RECONCILIATION_CONCURRENCY:-4}"
  EG_LDAP_RECONCILIATION_GROUP_QUERY_LIMIT: "${EG_LDAP_RECONCILIATION_GROUP_QUERY_LIMIT:-10000}"
  EG_LDAP_RECONCILIATION_GROUP_RESULT_LIMIT: "${EG_LDAP_RECONCILIATION_GROUP_RESULT_LIMIT:-100000}"
  EG_LDAP_GROUP_SEARCH_QUERY_LIMIT: "${EG_LDAP_GROUP_SEARCH_QUERY_LIMIT:-100}"
  EG_LDAP_GROUP_SEARCH_RESULT_LIMIT: "${EG_LDAP_GROUP_SEARCH_RESULT_LIMIT:-5000}"
EOF
}
