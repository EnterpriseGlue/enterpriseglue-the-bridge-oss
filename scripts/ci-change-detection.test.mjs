...
test('Mission Control engine, database, and diagram regressions remain explicit CI gates', () => {
  ...
  for (const requiredTest of [
    ...
    'engineSelectorStore.test.ts',
    'ProcessesOverviewPage.completed.test.tsx',
    'ProcessesOverviewPage.diagram-placeholder.test.tsx',
    'ProcessesOverviewPage.selection.test.tsx',
    'ProcessesDataTable.test.tsx',
    'processes-overview/components/modals/RetryModal.test.tsx',
    'useBulkOperations.test.ts',
    'useProcessesData.test.ts',
    'useProcessesModalData.test.ts',
    'ProcessInstanceDiagramPane.test.tsx',
    'useInstanceData.test.ts',
    'useInstanceModification.test.ts',
    'useInstanceRetry.test.ts',
    'useVariableEditor.test.ts',
    'process-instance-detail/components/modals/TerminateConfirmModal.test.tsx',
    'DecisionsDataTable.test.tsx',
    'MigrationWizardSession.test.ts',
    'migration-wizard/hooks/useMigrationData.test.tsx',
    'CopyableLink.test.tsx',
    'MissionControlEngineContextBoundary.test.tsx',
    'engineContext.test.ts',
    'ProSidebar.test.tsx',
    'viewerUtils.test.ts',
    'voyagerNavigation.test.ts',
  ]) {
