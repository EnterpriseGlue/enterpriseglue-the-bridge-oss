...
import { RetryModal } from '@src/features/mission-control/process-instance-detail/components/modals/RetryModal';
...
const baseProps = {
  open: true,
  retryBusy: false,
  retryActivityFilter: null,
  filteredRetryItems: [{ id: 'job-1', itemType: 'job', activityId: 'task', retries: 0 }],
  retrySelectionMap: { 'job-1': true },
  retryDueMode: 'keep' as const,
  retryDueInput: '',
  onClose: vi.fn(),
  onSubmit: vi.fn(),
  onActivityFilterClear: vi.fn(),
  onDueModeChange: vi.fn(),
  onDueInputChange: vi.fn(),
  onSelectionChange: vi.fn(),
};

describe('ProcessInstanceDetail RetryModal', () => {
