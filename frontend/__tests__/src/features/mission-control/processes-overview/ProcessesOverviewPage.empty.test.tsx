...
vi.mock('@src/features/mission-control/processes-overview/hooks', async () => {
  ...
  return {
    ...
    useProcessesModalData: () => ({
      allRetryItems: [],
      retryJobsQ: { data: [], isLoading: false },
      retryExtTasksQ: { data: [], isLoading: false },
...
describe('ProcessesOverviewPage empty state', () => {
  it('renders empty state when there are no instances', async () => {
