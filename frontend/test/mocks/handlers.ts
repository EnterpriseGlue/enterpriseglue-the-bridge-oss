...
export const handlers = [
  ...
  http.get('/api/authz/legacy-mapping-coverage', () => HttpResponse.json([])),
  http.get('/api/authz/legacy-mapping-retirement-readiness', () => HttpResponse.json({ ready: true, activeLegacyMappingCount: 0, verifiedReplacementCount: 0, blockers: [] })),
